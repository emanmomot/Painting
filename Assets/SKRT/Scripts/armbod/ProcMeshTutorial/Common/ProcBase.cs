...
{
	private Vector3[] vertexEdit = null;
	private Vector3[] normalEdit = null;
	...
	protected void BeginMeshEdit(Mesh mesh) {
		if (vertexEdit == null) {
			vertexEdit = mesh.vertices;
			normalEdit = mesh.normals;
		}
	}

	protected void EndMeshEdit(Mesh mesh) {
		mesh.vertices = vertexEdit;
		mesh.normals = normalEdit;
	}
